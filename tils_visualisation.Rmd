...
VlnPlot(T_cells, features = c("ICOS","CTLA4","KLRD1","IRF8","KLRC1","TOX"), assay = "RNA", stack=TRUE, flip= TRUE, fill.by = "ident")+theme(axis.text.y =element_text(size=4))+  theme_classic() +  scale_fill_manual(values= c("#A799B7", "#DD614A"))+theme(axis.text.x = element_text(angle = 70, hjust=1, size=12), axis.title.x = element_blank()) + theme(axis.title.y=element_text(size=12))+
geom_boxplot(alpha=0.3,show.legend = FALSE)
...
VlnPlot(T_cells, features = c("GZMB","PRF1","IFNG","TNF"), assay = "RNA", stack=TRUE, flip= TRUE, fill.by = "ident")+theme(axis.text.y =element_text(size=6))+  theme_classic() +  scale_fill_manual(values= c("#A799B7", "#DD614A"))+theme(axis.text.x = element_text(angle = 70, hjust=1, size=12), axis.title.x = element_blank()) + theme(axis.title.y=element_text(size=12)) +
geom_boxplot(alpha=0.3,show.legend = FALSE)
...
VlnPlot(T_cells, features = c("GZMC","GZMA","KLRG1","CD52", fill.by = "ident"), assay = "RNA", stack=TRUE, flip= TRUE)+theme(axis.text.y =element_text(size=6))+  theme_classic() +  scale_fill_manual(values= c("#A799B7", "#DD614A"))+theme(axis.text.x = element_text(angle = 70, hjust=1, size=12), axis.title.x = element_blank()) + theme(axis.title.y=element_text(size=12))+
geom_boxplot(alpha=0.3,show.legend = FALSE)
...
VlnPlot(T_cells, features = c("CD69","ENTPD1"), fill.by = "ident", assay = "RNA", stack=TRUE, flip= TRUE)+theme(axis.text.y =element_text(size=6))+  theme_classic() +  scale_fill_manual(values= c("#A799B7", "#DD614A"))+theme(axis.text.x = element_text(angle = 70, hjust=1, size=12), axis.title.x = element_blank()) + theme(axis.title.y=element_text(size=12))+
geom_boxplot(alpha=0.3,show.legend = FALSE)
