...
#### i. early activated
```{r message=FALSE, warning=FALSE, cache= TRUE, fig.width=18, fig.height= 50}
FeaturePlot(T_cells, features = c("GZMK","FOS","CD69","ZFP36","FOSB","CCL5","GRZMM","DUSP2","LYAR","SAMD3","CXCR4","CTSW","ANXA1","KLRG1","AOAH","TAGAP","KLRD1","IER2","GZMA","CST7","ITM2C","PARP8","BTG2"),order=TRUE,pt.size=1, reduction="tsne", ncol=3)
ggsave(file = "figures/Tcells/features_T_nature_early activated.png", dpi=300, width=30, height=80, limitsize= FALSE)
```

#### ii. precursor exhausted
```{r message=FALSE, warning=FALSE, cache= TRUE, fig.width=24, fig.height= 64}
FeaturePlot(T_cells, features = c("LAG3","XCL1","CRTAM","IFNG","CCL4","PDCD1","DUSP4","ZEB2","NR4A2","SLA","NKG7","TIGIT","CTSW","TNFRSF9","TOX","LYST","TNFSF4","CCL3","GZMB","RAB27A","PRF1","CD70","PLSCR1","CXCL13"),order=TRUE,pt.size=1, reduction="tsne", ncol=3)
ggsave(file = "figures/Tcells/features_T_nature_precursor exhausted.png", dpi=300, width=30, height=80, limitsize= FALSE)
```
  
#### iii. terminally exhausted effector
```{r message=FALSE, warning=FALSE, cache= TRUE, fig.width=24, fig.height= 64}
FeaturePlot(T_cells, features = c("LAG3","PRF1","HAVCR2","GZMB","NKG7","CTSD","KLRD1","ID2","CST7","PDCD1","TNFRSF9","TIGIT","CTSW","CCL4","CD63","CCL3","IFNG","CXCR6","FASL","RBPJ","CHST12","FAM3C","CSF1"),order=TRUE,pt.size=1, reduction="tsne", ncol=3)
ggsave(file = "figures/Tcells/features_T_nature_exhausted.png", dpi=300, width=30, height=80, limitsize= FALSE)
```
  
  
#### iv. naive-like (naive or central memory)
```{r message=FALSE, warning=FALSE, cache= TRUE, fig.width=24, fig.height= 24}
FeaturePlot(T_cells, features = c("CCR7","IL7R","SELL","TCF7","TXK","S1PR1","LEF1","SATB1"),order=TRUE,pt.size=1, reduction="tsne", ncol=3)
ggsave(file = "figures/Tcells/T_features_T_nature_naive-like.png", dpi=300, width=30, height=30)
```

  
#### v. effector memory
```{r message=FALSE, warning=FALSE, cache= TRUE, fig.width=24, fig.height= 64}
FeaturePlot(T_cells, features = c("GZMA","GZMK","NKG7","CTSW","GZMB","CCL5","CST7","PRF1","ABI3","FASL","ITM2C","1500009L16RIK","EOMES","CHST12","CCR5","HCST","AOAH","HOPX","SLAMF7","CXCR3","OASL1","F2R","CXCR6"),order=TRUE,pt.size=1, reduction="tsne", ncol=3)
ggsave(file = "figures/Tcells/T_features_T_nature_effector memory.png", dpi=300, width=30, height=80, limitsize= FALSE)
```
...
a
ggsave(file = "plots/myeloid/CD8_memory_Cxcl10.png", dpi=300, width=5, height=5)
...
f
ggsave(file = "figures/Tcells/CD4_CD8_naive_memory_CD4 CD8 naive/memory.png", dpi=300, width=5, height=5)
