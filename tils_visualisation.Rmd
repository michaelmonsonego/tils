...
```{r eval=FALSE, fig.height=, message=FALSE, warning=FALSE, cache=TRUE, include=FALSE}
...
```{r echo=FALSE, fig.height=4,fig.width=4, message=FALSE, warning=FALSE, cache=FALSE}
