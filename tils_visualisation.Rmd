...
```{r message=FALSE, warning=FALSE, cache= TRUE, fig.height= 32}
...
```{r message=FALSE, warning=FALSE, cache= TRUE, fig.height= 56}
...
### b. naive/memory
```{r fig.height=6, message=FALSE, warning=FALSE, cache=TRUE}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, cache=TRUE, fig.height=6}
