...
DimPlot(T_cells , reduction = "tsne", label= T, pt.size=0.5, label.size = 10) + ggplot2::theme(legend.position = "none")
...
p3 <- ggplot(mfrque, aes(x = Cluster, y = normalizedppstatus, fill = patient)) +
 ...
 theme(
   axis.text.x  = element_text(angle = 340, hjust = 1, size = 15, color = "black"),
