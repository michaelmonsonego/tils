...
clusters_to_keep <- setdiff(levels(Idents(T_cells_1)), "5")
...
T_cells_1_excluded_5 <- readRDS("objects/.rds")
...
Ts <- c('Cd4', 'Cd8a', 'Cd3d','Cd3e','Cd3g',"PTPRC")
Ts <- toupper(Ts)
FeaturePlot(T_cells_1_excluded_5, features = Ts, order=TRUE,pt.size=1, reduction="tsne", ncol=3)
